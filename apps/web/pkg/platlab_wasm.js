/* @ts-self-types="./platlab_wasm.d.ts" */
...
export class Core {
     ...
     */
    reset(x, y, w, h) {
        wasm.core_reset(this.__wbg_ptr, x, y, w, h);
    }
    /**
    ...
    set_params_json(json) {
        ...
        wasm.core_set_params_json(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    set_world(rects) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.core_set_world(this.__wbg_ptr, ptr0, len0);
    }
    /**
     ...
     */
    step(input_bits) {
        const ret = wasm.core_step(this.__wbg_ptr, input_bits);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('platlab_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
